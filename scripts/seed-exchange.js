/** In order to run the script on Kovan,
 * accounts declared in .env must have ETH (~0.5 ETH/e)
...
module.exports = async function(callback) {
  try {
    ...
    // Getting current trade fee
    result = await exchange.calcFee()
    const fee = result.logs[0].args.fee.toString()
    console.log('\nCurrent trade fee ($1 in Wei): ', fee)
    ...
    await exchange.fillOrder(orderId, { from: user2, value: fee })
